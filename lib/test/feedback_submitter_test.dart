  ...
  group('FeedbackSubmitter', () {
    ...
    group('submit', () {
      ...
      test('multiple submits append distinct lines', () {
        ...
        submitter.submit(category: FeedbackCategory.feature, message: 'Feature 1');
    ...
    group('list', () {
      ...
      test('returns empty list when file does not exist', () {
        final s = FeedbackSubmitter(storagePath: '/tmp/nonexistent_zgl_feedback.ndjson');
    ...
    group('clear', () {
      ...
      test('submit after clear creates a fresh file', () {
        submitter.submit(category: FeedbackCategory.bug, message: 'Before clear');
        submitter.clear();
        submitter.submit(category: FeedbackCategory.feature, message: 'After clear');
        final entries = submitter.list();
