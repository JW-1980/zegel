...
class DiscloseCommand extends Command<int> {
  ...
  DiscloseCommand() {
    ...
    argParser.addOption(
      ...
      abbr: 'b',
      help:
          'Comma-separated list of block indices to disclose.\n'
    ...
    argParser.addOption(
      'token-expires',
      help:
          'Expiration date for the token (YYYY-MM-DD).\n'
    ...
    argParser.addOption(
      'recipient',
      help:
          'Optional recipient identifier for the token.\n'
...
class ExtractWithTokenCommand extends Command<int> {
  ...
  ExtractWithTokenCommand() {
    argParser.addOption(
      ...
      abbr: 't',
      help:
          'Path to the disclosure token JSON file\n'
    ...
    argParser.addFlag(
      'metadata-only',
      help:
          'Only extract metadata blocks (no file content).\n'
